...
It initializes the collaboration protocol first, keeps the initial repository minimal, and lets project-specific structure grow later through explicit docs, skills, and changes.
